...
export default function Loading({ SkeletonNumber }) {
    return (
        <div className='container mx-auto px-4 pt-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
            {Array.from({ length: SkeletonNumber }, (_, i) => (
                <div role="status" key={i} className="flex flex-col gap-4 w-full max-w-sm m-auto border border-gray-200 p-4 rounded-lg overflow-hidden">
